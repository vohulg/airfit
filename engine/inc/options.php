...
HTML;
	...
	showRow( $lang['opt_sys_ht'], $lang['opt_sys_htd'], "<input class=\"edit bk\" type=text style=\"text-align: center;width:368px;\" name=\"save_con[home_title]\" value=\"{$config['home_title']}\">" );
	showRow( $lang['opt_sys_hu'], $lang['opt_sys_hud'], "<input class=\"edit bk\" type=text style=\"text-align: center;width:368px;\" name=\"save_con[http_home_url]\" value=\"{$config['http_home_url']}\">" );
	showRow( $lang['opt_sys_chars'], $lang['opt_sys_charsd'], "<input class=\"edit bk\" type=\"text\" style=\"text-align: center;width:368px;\" name=\"save_con[charset]\" value=\"{$config['charset']}\">" );
	showRow( $lang['opt_sys_descr'], $lang['opt_sys_descrd'], "<input class=\"edit bk\" type=\"text\" style=\"width:368px;\" name=\"save_con[description]\" value=\"{$config['description']}\">" );
	showRow( $lang['opt_sys_key'], $lang['opt_sys_keyd'], "<textarea class=\"edit bk\" style=\"width:374px;height:50px;\" name=\"save_con[keywords]\">{$config['keywords']}</textarea>" );
	showRow( $lang['opt_sys_short_name'], $lang['opt_sys_short_named'], "<input class=\"edit bk\" type=\"text\" style=\"text-align: center;width:368px;\" name=\"save_con[short_title]\" value=\"{$config['short_title']}\">" );
	...
	showRow( $lang['opt_sys_smc'], $lang['opt_sys_smcd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[allow_complaint_mail]", "{$config['allow_complaint_mail']}" ) );
	...
	showRow( $lang['opt_sys_reason'], $lang['opt_sys_reasond'], "<textarea class=\"edit bk\" style=\"width:374px;height:100px;\" name=\"save_con[offline_reason]\">{$config['offline_reason']}</textarea>" );
...
HTML;
	...
	showRow( $lang['opt_sys_addsec'], $lang['opt_sys_addsecd'], makeDropDown( array ( "0" => $lang['opt_sys_r1'], "2" => $lang['opt_sys_r4'], "1" => $lang['opt_sys_r5'] ), "save_con[sec_addnews]", "{$config['sec_addnews']}" ) );
	showRow( $lang['opt_sys_sapi'], $lang['opt_sys_sapid'], "<input class=\"edit bk\" type=text name=\"save_con[spam_api_key]\" value=\"{$config['spam_api_key']}\" size=40>" );
	...
	showRow( $lang['opt_sys_recaptpub'], $lang['opt_sys_recaptpubd'], "<input class=\"edit bk\" type=text name=\"save_con[recaptcha_public_key]\" value=\"{$config['recaptcha_public_key']}\" size=40>" );
	showRow( $lang['opt_sys_recaptpriv'], $lang['opt_sys_recaptpubd'], "<input class=\"edit bk\" type=text name=\"save_con[recaptcha_private_key]\" value=\"{$config['recaptcha_private_key']}\" size=40>" );
...
HTML;
	...
	showRow( $lang['opt_sys_top_num'], $lang['opt_sys_top_numd'], "<input class=\"edit bk\" type=text style=\"text-align: center;\"  name=\"save_con[top_number]\" value=\"{$config['top_number']}\" size=10>" );
	showRow( $lang['opt_sys_cloud_num'], $lang['opt_sys_cloud_numd'], "<input class=\"edit bk\" type=text style=\"text-align: center;\"  name=\"save_con[tags_number]\" value=\"{$config['tags_number']}\" size=10>" );
	...
	showRow( $lang['opt_sys_mhs'], $lang['opt_sys_mhsd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[allow_share]", "{$config['allow_share']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_wdcom'], $lang['opt_sys_wdscomd'], makeDropDown( array ("0" => $lang['editor_def'], "1" => "LiveEditor (WYSIWYG)", "2" => "TinyMCE (WYSIWYG)" ), "save_con[allow_comments_wysiwyg]", "{$config['allow_comments_wysiwyg']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_cc'], $lang['opt_sys_ccd'], "<input class=\"edit bk\" type=text style=\"text-align: center;\" name=\"save_con[clear_cache]\" value=\"{$config['clear_cache']}\" size=10>" );
	...
	showRow( $lang['opt_sys_online'], $lang['opt_sys_onlined'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[online_status]", "{$config['online_status']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_mt'], $lang['opt_sys_mtd'], "<input class=\"edit bk\" type=\"text\" style=\"text-align: center;\" name='save_con[mail_title]' value=\"{$config['mail_title']}\" size=50>" );
	...
	showRow( $lang['opt_sys_usm'], $lang['opt_sys_usmd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[use_admin_mail]", "{$config['use_admin_mail']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_rmip'], $lang['opt_sys_rmipd'], makeDropDown( array ("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no'] ), "save_con[reg_multi_ip]", "{$config['reg_multi_ip']}" ) );
...
HTML;
	...
	showRow( $lang['opt_sys_av'], $lang['opt_sys_avd'], "<input class=\"edit bk\" type=text style=\"text-align: center;\"  name='save_con[avatar_size]' value=\"{$config['avatar_size']}\" size=10>" );
