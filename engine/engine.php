...
switch ( $do ) {
	...
	case "pm" :
		...
		break;
            ...
            // TWS Gallery Setup begin
	case "gallery" :
		if (!defined('TWSGAL_DIR')){ die ( "Допущена ошибка при редактировании файла init.php или файл не был перезалит на сервер! Данная надпись означает, что dle не видит путь, по которому расположены файлы галереи!" ); }
		include TWSGAL_DIR.'/main.php';
		break;
// TWS Gallery Setup end
...
// TWS Gallery Setup begin
if ($do == 'gallery') $nam_e = $s_navigation;
// TWS Gallery Setup end
